...
{
    public static class DapperSelectBuilderExtensions
    {
        ...
        {
            return cnn.ExecuteReader(builder.GetSqlText(), builder.Parameters, transaction, commandTimeout, commandType);
        }
        public static IEnumerable<dynamic> Query(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<object> Query(this IDbConnection cnn, Type type, IBuilder builder,
            IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = default(int?),
            CommandType? commandType = default(CommandType?))
        {
            return cnn.Query(type, builder.GetSqlText(), builder.Parameters, transaction, buffered, commandTimeout, commandType);
        }
        public static IEnumerable<T> Query<T>(this IDbConnection cnn, IBuilder builder, SqlTransaction transaction = null,
        ...
        public static IEnumerable<TReturn> Query<TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(this IDbConnection cnn, IBuilder builder,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(this IDbConnection cnn, IBuilder builder,
