...
{
    public static class QueryAsyncSelectExtensions
    {
        public static Task<IEnumerable<dynamic>> QueryAsync(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<object>> Query(this IDbConnection cnn, Type type, RawSelectBuilder builder,
            IDbTransaction transaction = null, int? commandTimeout = default(int?),
            CommandType? commandType = default(CommandType?))
        {
            return cnn.QueryAsync(type, builder.GetSqlText(), builder.Parameters, transaction, commandTimeout, commandType);
        }
        public static Task<IEnumerable<T>> Query<T>(this IDbConnection cnn, RawSelectBuilder builder, SqlTransaction transaction = null,
        ...
        public static Task<IEnumerable<TReturn>> Query<TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TThird, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TThird, TFourth, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
        ...
        public static Task<IEnumerable<TReturn>> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(this IDbConnection cnn, RawSelectBuilder builder,
